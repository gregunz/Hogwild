...
object SlaveServiceGrpc {
  val METHOD_UPDATE_WEIGHTS: _root_.io.grpc.MethodDescriptor[hogwild.grpc.SlaveRequest, hogwild.grpc.SlaveResponse] =
    _root_.io.grpc.MethodDescriptor.newBuilder()
      .setType(_root_.io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
      .setFullMethodName(_root_.io.grpc.MethodDescriptor.generateFullMethodName("hogwild.SlaveService", "UpdateWeights"))
      .setRequestMarshaller(new scalapb.grpc.Marshaller(hogwild.grpc.SlaveRequest))
      .setResponseMarshaller(new scalapb.grpc.Marshaller(hogwild.grpc.SlaveResponse))
      .build()
  
  val SERVICE: _root_.io.grpc.ServiceDescriptor =
    _root_.io.grpc.ServiceDescriptor.newBuilder("hogwild.SlaveService")
  ...
  trait SlaveService extends _root_.scalapb.grpc.AbstractService {
    ...
    def updateWeights(responseObserver: _root_.io.grpc.stub.StreamObserver[hogwild.grpc.SlaveResponse]): _root_.io.grpc.stub.StreamObserver[hogwild.grpc.SlaveRequest]
  }
  ...
  class SlaveServiceStub(channel: _root_.io.grpc.Channel, options: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT) extends _root_.io.grpc.stub.AbstractStub[SlaveServiceStub](channel, options) with SlaveService {
    override def updateWeights(responseObserver: _root_.io.grpc.stub.StreamObserver[hogwild.grpc.SlaveResponse]): _root_.io.grpc.stub.StreamObserver[hogwild.grpc.SlaveRequest] = {
  ...
  def bindService(serviceImpl: SlaveService, executionContext: scala.concurrent.ExecutionContext): _root_.io.grpc.ServerServiceDefinition =
    ...
    .addMethod(
      ...
      _root_.io.grpc.stub.ServerCalls.asyncBidiStreamingCall(new _root_.io.grpc.stub.ServerCalls.BidiStreamingMethod[hogwild.grpc.SlaveRequest, hogwild.grpc.SlaveResponse] {
        override def invoke(observer: _root_.io.grpc.stub.StreamObserver[hogwild.grpc.SlaveResponse]): _root_.io.grpc.stub.StreamObserver[hogwild.grpc.SlaveRequest] =
