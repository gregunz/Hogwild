...
object WorkerServiceAsyncGrpc {
  val METHOD_HELLO: _root_.io.grpc.MethodDescriptor[grpc.async.HelloRequest, grpc.async.HelloResponse] =
    _root_.io.grpc.MethodDescriptor.newBuilder()
      ...
      .setRequestMarshaller(new scalapb.grpc.Marshaller(grpc.async.HelloRequest))
  ...
  trait WorkerServiceAsync extends _root_.scalapb.grpc.AbstractService {
    ...
    def hello(request: grpc.async.HelloRequest): scala.concurrent.Future[grpc.async.HelloResponse]
  ...
  trait WorkerServiceAsyncBlockingClient {
    ...
    def hello(request: grpc.async.HelloRequest): grpc.async.HelloResponse
  ...
  class WorkerServiceAsyncBlockingStub(channel: _root_.io.grpc.Channel, options: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT) extends _root_.io.grpc.stub.AbstractStub[WorkerServiceAsyncBlockingStub](channel, options) with WorkerServiceAsyncBlockingClient {
    override def hello(request: grpc.async.HelloRequest): grpc.async.HelloResponse = {
  ...
  class WorkerServiceAsyncStub(channel: _root_.io.grpc.Channel, options: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT) extends _root_.io.grpc.stub.AbstractStub[WorkerServiceAsyncStub](channel, options) with WorkerServiceAsync {
    override def hello(request: grpc.async.HelloRequest): scala.concurrent.Future[grpc.async.HelloResponse] = {
  ...
  def bindService(serviceImpl: WorkerServiceAsync, executionContext: scala.concurrent.ExecutionContext): _root_.io.grpc.ServerServiceDefinition =
    ...
    .addMethod(
      METHOD_HELLO,
      _root_.io.grpc.stub.ServerCalls.asyncUnaryCall(new _root_.io.grpc.stub.ServerCalls.UnaryMethod[grpc.async.HelloRequest, grpc.async.HelloResponse] {
        override def invoke(request: grpc.async.HelloRequest, observer: _root_.io.grpc.stub.StreamObserver[grpc.async.HelloResponse]): Unit =
