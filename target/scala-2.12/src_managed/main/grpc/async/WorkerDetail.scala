...
final case class WorkerDetail(
    ...
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      ...
      if (port != 0L) { __size += _root_.com.google.protobuf.CodedOutputStream.computeUInt64Size(2, port) }
      __size
    }
    ...
    def withAddress(__v: _root_.scala.Predef.String): WorkerDetail = copy(address = __v)
    def withPort(__v: _root_.scala.Long): WorkerDetail = copy(port = __v)
