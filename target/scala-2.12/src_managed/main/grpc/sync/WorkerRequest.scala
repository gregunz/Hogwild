...
final case class WorkerRequest(
    ...
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      var __size = 0
      gradient.foreach(gradient => __size += 1 + _root_.com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(grpc.sync.WorkerRequest._typemapper_gradient.toBase(gradient).serializedSize) + grpc.sync.WorkerRequest._typemapper_gradient.toBase(gradient).serializedSize)
      __size
    }
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): grpc.sync.WorkerRequest = {
    ...
    def companion = grpc.sync.WorkerRequest
}

object WorkerRequest extends scalapb.GeneratedMessageCompanion[grpc.sync.WorkerRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[grpc.sync.WorkerRequest] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): grpc.sync.WorkerRequest = {
    require(__fieldsMap.keys.forall(_.getContainingType() == javaDescriptor), "FieldDescriptor does not match message type.")
    val __fields = javaDescriptor.getFields
    grpc.sync.WorkerRequest(
      __fieldsMap.getOrElse(__fields.get(0), Nil).asInstanceOf[_root_.scala.collection.Seq[grpc.sync.WorkerRequest.GradientEntry]].map(grpc.sync.WorkerRequest._typemapper_gradient.toCustom)(_root_.scala.collection.breakOut)
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[grpc.sync.WorkerRequest] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_]] = Seq[_root_.scalapb.GeneratedMessageCompanion[_]](
    _root_.grpc.sync.WorkerRequest.GradientEntry
  )
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = grpc.sync.WorkerRequest(
  )
  @SerialVersionUID(0L)
  final case class GradientEntry(
      ...
      def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): grpc.sync.WorkerRequest.GradientEntry = {
        var __key = this.key
        ...
        grpc.sync.WorkerRequest.GradientEntry(
            key = __key,
            value = __value
        )
      }
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion = grpc.sync.WorkerRequest.GradientEntry
  }
  
  object GradientEntry extends scalapb.GeneratedMessageCompanion[grpc.sync.WorkerRequest.GradientEntry] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[grpc.sync.WorkerRequest.GradientEntry] = this
    def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): grpc.sync.WorkerRequest.GradientEntry = {
      require(__fieldsMap.keys.forall(_.getContainingType() == javaDescriptor), "FieldDescriptor does not match message type.")
      val __fields = javaDescriptor.getFields
      grpc.sync.WorkerRequest.GradientEntry(
    ...
    implicit def messageReads: _root_.scalapb.descriptors.Reads[grpc.sync.WorkerRequest.GradientEntry] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        require(__fieldsMap.keys.forall(_.containingMessage == scalaDescriptor), "FieldDescriptor does not match message type.")
        grpc.sync.WorkerRequest.GradientEntry(
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = grpc.sync.WorkerRequest.javaDescriptor.getNestedTypes.get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = grpc.sync.WorkerRequest.scalaDescriptor.nestedMessages(0)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
    lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_]] = Seq.empty
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
    lazy val defaultInstance = grpc.sync.WorkerRequest.GradientEntry(
    )
    implicit class GradientEntryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, grpc.sync.WorkerRequest.GradientEntry]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, grpc.sync.WorkerRequest.GradientEntry](_l) {
    ...
    implicit val keyValueMapper: _root_.scalapb.TypeMapper[grpc.sync.WorkerRequest.GradientEntry, (_root_.scala.Int, _root_.scala.Double)] =
      _root_.scalapb.TypeMapper[grpc.sync.WorkerRequest.GradientEntry, (_root_.scala.Int, _root_.scala.Double)](__m => (__m.key, __m.value))(__p => grpc.sync.WorkerRequest.GradientEntry(__p._1, __p._2))
  }
